...
static int
qiarray_parse_shape(PyObject *shape_obj, int *nd_out, npy_intp **dims_out)
{
  PyObject *seq;
  Py_ssize_t nd;
  npy_intp i;
...
static int
qiarray_parse_order(PyObject *order_obj, NPY_ORDER *order, NPY_ORDER default_order)
{
  Py_UCS4 value;
...
static PyObject *
qiarray_from_object(PyObject *obj, int copy, NPY_ORDER order, int ndmin)
{
  int requirements;
  PyArray_Descr *descr;
  PyArrayObject *arr;
...
qiarray_zeros(PyObject *NPY_UNUSED(self), PyObject *args)
{
  ...
  if (qiarray_parse_shape(shape_obj, &nd, &dims) < 0) {
    return NULL;
  }

  arr = QuadIArray_new_empty(nd, dims);
  PyMem_Free(dims);
  if (arr == NULL) {
    return NULL;
  }
...
qiarray_from_array(PyObject *NPY_UNUSED(self), PyObject *args)
{
  ...
  return qiarray_from_object(obj, 1, NPY_KEEPORDER, 0);
}

static PyObject *
qiarray_asarray(PyObject *NPY_UNUSED(self), PyObject *args, PyObject *kwargs)
{
  ...
  if (qiarray_parse_order(order_obj, &order, NPY_KEEPORDER) < 0) {
    return NULL;
  }

  return qiarray_from_object(obj, copy, order, (int)ndmin);
}

static PyObject *
qiarray_array(PyObject *NPY_UNUSED(self), PyObject *args, PyObject *kwargs)
{
  static char *kwlist[] = {"values", "copy", "order", "ndmin", NULL};
  PyObject *obj;
  PyObject *order_obj = NULL;
...
static PyObject *
qiarray_asfortranarray(PyObject *self, PyObject *args)
{
  PyObject *arr_obj;
  PyObject *f_arr;
...
static PyObject *
qiarray_ravel(PyObject *NPY_UNUSED(self), PyObject *args, PyObject *kwargs)
{
  ...
  if (qiarray_parse_order(order_obj, &order, NPY_CORDER) < 0) {
    return NULL;
  }

  arr_obj = qiarray_from_object(obj, 0, NPY_KEEPORDER, 0);
  if (arr_obj == NULL) {
    return NULL;
  }
...
static PyMethodDef QuadIArrayMethods[] = {
  ...
  {"asarray", (PyCFunction)qiarray_asarray, METH_VARARGS | METH_KEYWORDS, "Create a qiarray from an array-like object."},
  {"array", (PyCFunction)qiarray_array, METH_VARARGS | METH_KEYWORDS, "Create a qiarray from an array-like object."},
  {"asfortranarray", qiarray_asfortranarray, METH_VARARGS, "Create a Fortran-contiguous qiarray from an array-like object."},
  {"ravel", (PyCFunction)qiarray_ravel, METH_VARARGS | METH_KEYWORDS, "Return a contiguous flattened qiarray from an array-like object."},
