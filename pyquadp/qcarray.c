...
qcarray_empty(PyObject *NPY_UNUSED(self), PyObject *args)
{
    ...
    dims[0] = (npy_intp)n;
    return (PyObject *)QuadCArray_new_empty(1, dims);
}
...
static PyObject *
qcarray_ravel(PyObject *self, PyObject *args)
{
    PyObject *arr_obj;
    PyObject *flat_arr;
...
static PyMethodDef QuadCArrayMethods[] = {
    ...
    {"ravel", qcarray_ravel, METH_VARARGS, "Return a contiguous flattened qcarray from an array-like object."},
