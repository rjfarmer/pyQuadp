...
static void
QuadCArray_ufunc_power(char **args, const npy_intp *dims, const npy_intp *steps, void *NPY_UNUSED(data))
{
    npy_intp i;
    npy_intp n = dims[0];
    char *in1 = args[0];
    ...
    for (i = 0; i < n; ++i) {
        *(__complex128 *)out = cpowq(*(__complex128 *)in1, *(__complex128 *)in2);
        in1 += steps[0];
        in2 += steps[1];
        out += steps[2];
    }
...
static void
QuadCArray_ufunc_power_qc(char **args, const npy_intp *dims, const npy_intp *steps, void *NPY_UNUSED(data))
{
    npy_intp i;
    npy_intp n = dims[0];
    char *inq = args[0];
    ...
    for (i = 0; i < n; ++i) {
        *(__complex128 *)out = cpowq(*(__complex128 *)inq, qcomplex_from_cdouble(*(npy_cdouble *)inc));
        inq += steps[0];
        inc += steps[1];
        out += steps[2];
    }
...
static void
QuadCArray_ufunc_power_cq(char **args, const npy_intp *dims, const npy_intp *steps, void *NPY_UNUSED(data))
{
    npy_intp i;
    npy_intp n = dims[0];
    char *inc = args[0];
    ...
    for (i = 0; i < n; ++i) {
        *(__complex128 *)out = cpowq(qcomplex_from_cdouble(*(npy_cdouble *)inc), *(__complex128 *)inq);
        inc += steps[0];
        inq += steps[1];
        out += steps[2];
    }
...
QuadCArray_register_ufuncs(void)
{
    ...
    if (QuadCArray_register_ufunc_binary("power", QuadCArray_ufunc_power) < 0) {
        return -1;
    }
    ...
    if (QuadCArray_register_ufunc_binary_types("power", QuadCArray_ufunc_power_qc, QuadCArrayTypeNum, NPY_CDOUBLE, QuadCArrayTypeNum) < 0) {
        return -1;
    }
    if (QuadCArray_register_ufunc_binary_types("power", QuadCArray_ufunc_power_cq, NPY_CDOUBLE, QuadCArrayTypeNum, QuadCArrayTypeNum) < 0) {
        return -1;
    }
...
static int
qcarray_parse_shape(PyObject *shape_obj, int *nd_out, npy_intp **dims_out)
{
    PyObject *seq;
    Py_ssize_t nd;
    npy_intp i;
...
static int
qcarray_parse_order(PyObject *order_obj, NPY_ORDER *order, NPY_ORDER default_order)
{
    Py_UCS4 value;
...
static PyObject *
qcarray_from_object(PyObject *obj, int copy, NPY_ORDER order, int ndmin)
{
    int requirements;
    PyArray_Descr *descr;
    PyArrayObject *arr;
...
qcarray_zeros(PyObject *NPY_UNUSED(self), PyObject *args)
{
    ...
    if (qcarray_parse_shape(shape_obj, &nd, &dims) < 0) {
        return NULL;
    }

    arr = QuadCArray_new_empty(nd, dims);
    PyMem_Free(dims);
    if (arr == NULL) {
        return NULL;
    }
...
static PyObject *
qcarray_empty(PyObject *NPY_UNUSED(self), PyObject *args)
{
    PyObject *shape_obj;
    int nd;
    npy_intp *dims = NULL;
...
static PyObject *
qcarray_full(PyObject *NPY_UNUSED(self), PyObject *args)
{
    PyObject *shape_obj;
    PyObject *fill_obj;
    npy_intp i;
    ...
    if (QuadCArray_setitem(fill_obj, &fill, arr) < 0) {
        Py_DECREF(arr);
        return NULL;
    }
...
static PyObject *
qcarray_linspace(PyObject *NPY_UNUSED(self), PyObject *args)
{
    PyObject *start_obj;
    PyObject *stop_obj;
    Py_ssize_t num;
    ...
    if (QuadCArray_setitem(start_obj, &start, NULL) < 0) {
        return NULL;
    }
    if (QuadCArray_setitem(stop_obj, &stop, NULL) < 0) {
        return NULL;
    }
    ...
    if (endpoint) {
        ...
        for (i = 0; i < (npy_intp)num; ++i) {
            data[i] = start + ((__float128)i * step);
        }
        data[num - 1] = stop;
    } else {
...
qcarray_from_array(PyObject *NPY_UNUSED(self), PyObject *args)
{
    ...
    return qcarray_from_object(obj, 1, NPY_KEEPORDER, 0);
}

static PyObject *
qcarray_asarray(PyObject *NPY_UNUSED(self), PyObject *args, PyObject *kwargs)
{
    ...
    if (qcarray_parse_order(order_obj, &order, NPY_KEEPORDER) < 0) {
        return NULL;
    }

    return qcarray_from_object(obj, copy, order, (int)ndmin);
}

static PyObject *
qcarray_array(PyObject *NPY_UNUSED(self), PyObject *args, PyObject *kwargs)
{
    static char *kwlist[] = {"values", "copy", "order", "ndmin", NULL};
    PyObject *obj;
    PyObject *order_obj = NULL;
...
static PyObject *
qcarray_asfortranarray(PyObject *self, PyObject *args)
{
    PyObject *arr_obj;
    PyObject *f_arr;

    arr_obj = qcarray_from_array(self, args);
    if (arr_obj == NULL) {
        return NULL;
    }
...
static PyObject *
qcarray_ravel(PyObject *NPY_UNUSED(self), PyObject *args, PyObject *kwargs)
{
    ...
    if (qcarray_parse_order(order_obj, &order, NPY_CORDER) < 0) {
        return NULL;
    }

    arr_obj = qcarray_from_object(obj, 0, NPY_KEEPORDER, 0);
    if (arr_obj == NULL) {
        return NULL;
    }
...
static PyMethodDef QuadCArrayMethods[] = {
    ...
    {"full", qcarray_full, METH_VARARGS, "Create a 1-D qcarray filled with a value."},
    ...
    {"asarray", (PyCFunction)qcarray_asarray, METH_VARARGS | METH_KEYWORDS, "Create a qcarray from an array-like object."},
    {"array", (PyCFunction)qcarray_array, METH_VARARGS | METH_KEYWORDS, "Create a qcarray from an array-like object."},
    {"asfortranarray", qcarray_asfortranarray, METH_VARARGS, "Create a Fortran-contiguous qcarray from an array-like object."},
    {"ravel", (PyCFunction)qcarray_ravel, METH_VARARGS | METH_KEYWORDS, "Return a contiguous flattened qcarray from an array-like object."},
